...
public class CustomerBill extends javax.swing.JFrame {
    ...
    private void jButton_doneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_doneActionPerformed
        ...
        Dashboard.jLabel1_total = new JLabel("0.0");
        Dashboard.jLabel1_total.repaint();
        
        JOptionPane.showMessageDialog(rootPane, "Transaction Saved Successfully!");
        SaleConfig.printedSales++;
        
        try{
        Dashboard.totalPrice = Double.parseDouble(billAmt) - Double.parseDouble(balAmt);
        }catch(Exception e){
        Dashboard.totalPrice = 0.0;    
        }
        SaleConfig.Store();
        Dashboard d = new Dashboard();
        d.setVisible(true);
        BillEntry.total = 0.0;
        Dashboard.jLabel1_total.setText("0.0");
        Dashboard.priceDet.clear();
        Dashboard.itemDet.clear();
